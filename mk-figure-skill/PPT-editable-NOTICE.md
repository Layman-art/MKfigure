...
These upstream components are MIT licensed. Preserve the copyright and permission notice in `PPT-editable-LICENSE.txt` when redistributing them. The example deck and reference images from the upstream repository are not included in this skill.
